          ...
          <div className=" relative overflow-hidden ">
            <div className="w-[1170px] m-auto ">
              <div className="py-[50px] px-[40px]">
                ...
                <div>
                  <div className="pt-[40px] px-[40px] pb-[50px]">
                      ...
                      <div className="text-left">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap text-xl relative justify-between ">
                            <div className="text-left relative ml-[2px]">
                              10
                            </div>
                            <div className="text-left absolute left-[6%]">
                              25
                            </div>
              ...
              <div className="px-4 mt-[70px] items-center">
        ...
        <div className="bg-white pt-10 pb-[60px] ">
          <div className="max-w-[1170px] m-auto">
            <div className="text-center mb-16">
              <div className="px-8 mb-16 box-border">                 
